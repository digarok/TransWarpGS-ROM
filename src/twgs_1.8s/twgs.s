...
* Source Disassembly - V0.4 Release #2             *
*                                                  *
...
VERTCNT                 =   $C02E
HORIZCNT                =   $C02F
KEYBOARD                =   $E0C000                 ; Keyboard data register (read)
CLR80STORE              =   $E0C000                 ; Disable 80-column memory mapping (Write)
SET80STORE              =   $E0C001                 ; Enable 80-column memory mapping
CLR80VID                =   $E0C00C                 ; Disable 80-column display mode
SETALTCHR               =   $E0C00F                 ; Enable alternate character set
STROBE                  =   $E0C010                 ; Keyboard strobe (RW)
RD80COL                 =   $E0C018
RDHIRES                 =   $E0C01D

ADB_DATAREG             =   $E0C026                 ; ADB Command/Data
ADB_KMSTATUS            =   $E0C027                 ; ADB Status flags
SLTROMSEL               =   $E0C02D                 ; Slot Register; Bits 1-7=use slot card
CYAREG                  =   $E0C036                 ; Bits: 0-3=Disk Detect 4=Shadow All Banks Bit 7=Fast
SOUNDCTL                =   $E0C03C                 ; DOC Sound Bits: 0-3=Volume, 5=AutoInc, 6=RAM, 7=Busy
SOUNDDATA               =   $E0C03D                 ; DOC Sound Data Register
SOUNDADRL               =   $E0C03E                 ; DOC Sound Address Low Byte
SOUNDADRH               =   $E0C03F                 ; DOC Sound Address High Byte
TXTSET                  =   $E0C051                 ; Display Text
MIXCLR                  =   $E0C052                 ; Disable Mixed Mode
TXTPAGE1                =   $E0C054                 ; Display Text Page 1
TXTPAGE2                =   $E0C055                 ; Display Text Page 2
CLRHIRES                =   $E0C056                 ; Select Lo-Res mode
SETHIRES                =   $E0C057                 ; Select Hi-Res mode
MOTOR4OFF               =   $E0C0C8
MOTOR4ON                =   $E0C0C9
MOTOR5OFF               =   $E0C0D8
MOTOR5ON                =   $E0C0D9
...
:set_aux_mem            STAL TXTPAGE2
                        BRA :store_to_screen
:set_main_mem           STAL TXTPAGE1               ; $E0C054
:store_to_screen        PLA
                        LDX Text_Offset
                        AND Text_Mask
...
Test_Cache_Rom          PHB
                        ...
                        LDY #$8000
                        LDA Cache_Max_Mask
                        MVN TWGS_Config,TWGS_Config ; $BC0000,$BC0000
                        PLB
                        RTS
...
TWGS_Failed             PHP
                        ...
                        STAL CLRHIRES               ; $E0C056
                        STAL CLR80STORE             ; $E0C000
                        STAL CLR80VID               ; $E0C00C
                        STAL SETALTCHR              ; $E0C00F
                        LDA #$01
                        STAL $E0C029
                        REP #$30
                        NOP
...
LA200                   LDAL CYAREG                 ; $E0C036
                        ...
                        BNE :not_32K
                        LDX #:STR_32K
                        BRA :print_cache_size
:not_32K                LDX #:STR_8K
:print_cache_size       JSR Text_Out_Pascal_String
                        BRA :skip
:STR_32K                STR "32K Cache"
:STR_8K                 STR "8K Cache"
:skip                   LDX #$0002
                        LDY #$0004
                        JSR Text_Offset_For_X_Y
...
*----------- I can't see any calls to the following addresses...
...
Prepare_Intro_Audio     LDA TWGS_Config_Byte
...
LA931                   JSR Setup_DOC
                        ...
                        LDA #$E0
                        STAL SOUNDADRL
                        LDAL SOUNDDATA              ; $E0C03D
:loop                   LDAL SOUNDDATA              ; $E0C03D
                        BPL :loop
                        REP #$20
                        NOP
                        PLP
...
Prepare_Intro_DOC_Regs  LDA TWGS_Config_Byte
...
LAB11                   SEP #$20
                        ...
                        LDX $99
                        LDA #$00
:store_loop             STAL SOUNDDATA              ; $E0C03D
                        INX
                        CPX #$8000
                        BCC :store_loop
                        REP #$20
