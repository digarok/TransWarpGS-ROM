...
:loop                         STAL  $E11FFE,X
                              ...
                              LDY   #$0200
                              LDA   #$00B5
; MVN TWGS_Control,ptr000000 , $BC0000,$000000
                              MVN   $BC0000,$000000
                              PLB
                              RTS
...
String_TW_Revision            STR   "Revision 1.9-64K"
...
LFB24                         JMPL  LFA2F
                              ...
                              MX    %00
Version_Info_L                LDA   #$0000
                              LDX   #$0108
                              RTL

Reset_HW_Config_L             JSR   CONFIG_TW_From_NVRAM
                              JSR   Cache_ON
                              RTL

LFB36                         RTL

Get_NVRAM_Speed_L             JSR   NVRAM_Read_Speed
                              RTL

Get_Speed_Setting_Index_L     LDX   #$0003                        ; I believe the 3 is a speed setting (GB has GetNumISpeed)
                              RTL

Get_CPU_Frequency_L           LDA   #$0000
                              CPX   #$0003
                              BCS   :exit
                              CPX   #$0002
                              BCC   :get_from_table
...
Get_CPU_Frequency_Diff_L      PHA
                              LDX   #$0000
:loop                         JSL   Get_CPU_Frequency_L
                              CMP   $01,S
                              BCS   :found_it
                              INX
                              CPX   #$0003
                              BCC   :loop
                              DEX
:found_it                     JSL   Get_CPU_Frequency_L
                              SEC
                              SBC   $01,S
                              STA   $01,S
                              PLA
...
Get_Speed_and_Frequency_L     JSL   Get_TW_Speed_L                ; in X
                              JSL   Get_CPU_Frequency_L           ; in M
                              RTL
...
Set_Speed_From_Frequency_L    JSL   Get_CPU_Frequency_Diff_L
                              PHA
LFBDD                         JSL   Set_TW_Speed_L
                              PLA
                              RTL
...
Flush_Cache_L                 PHB
                              ...
                              LDX   #$8000
                              LDY   #$8000
LFBEE                         MVN   TWGS_Control,TWGS_Control
                              PLB
                              RTL

IRQ_Logic_OFF_L               JSR   IRQ_Logic_OFF
                              RTL

IRQ_Logic_ON_L                JSR   IRQ_Logic_ON
LFBFA                         RTL

Cache_ON_L                    JSR   Cache_ON
                              RTL

Cache_OFF_L                   JSR   Cache_OFF
                              RTL

Get_TW_Mode_L                 JSR   READ_TW_MODE
                              RTL

Set_TW_Mode_L                 JSR   SET_TW_MODE_KEEP_CACHE
                              RTL

Get_Cache_Size_L              JSR   Check_Cache_Size
                              LDX   #$000A
LFC11                         LSR
                              DEX
                              BNE   LFC11
...
TranswarpId                   ASC   'TWGS'                        ; happens to be at $FF00
TranswarpId2                  ASC   'SMJS'                        ; not really sure

                              JMPL  Version_Info_L
                              JMPL  Reset_HW_Config_L
                              JMPL  Get_NVRAM_Speed_L             ; get "max" speed?
                              JMPL  Get_Speed_Setting_Index_L
                              JMPL  Get_CPU_Frequency_Diff_L
                              JMPL  Get_CPU_Frequency_L
                              JMPL  Get_Speed_and_Frequency_L
                              JMPL  Set_Speed_From_Frequency_L
                              JMPL  Get_TW_Speed_L
                              JMPL  Set_TW_Speed_L
                              JMPL  Flush_Cache_L
                              JMPL  IRQ_Logic_OFF_L
                              JMPL  IRQ_Logic_ON_L
                              JMPL  Get_TW_Mode_L
                              JMPL  Set_TW_Mode_L
                              JMPL  Get_Cache_Size_L
                              JMPL  Cache_ON_L
                              JMPL  Cache_OFF_L
